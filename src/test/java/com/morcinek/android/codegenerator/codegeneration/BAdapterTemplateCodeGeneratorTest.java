...
public class BAdapterTemplateCodeGeneratorTest {
    ...
    public void setUp() throws Exception {
        templateCodeGenerator = new TemplateCodeGenerator("BAdapter_template", new BAdapterResourceProvidersFactory(), new ResourceTemplatesProvider());
    }
    ...
    public void produceMainActivityCodeTest() throws Exception {
        ...
        // then
        String expectedCode = templatesProvider.provideTemplateForName("results/adapters/BMainAdapter.java");
    ...
    public void produceTermsActivityCodeTest() throws Exception {
        ...
        // then
        String expectedCode = templatesProvider.provideTemplateForName("results/adapters/BTermsAdapter.java");
        Assertions.assertThat(generatedCode).isNotNull().isEqualTo(expectedCode);
    }
    ...
    public void produceFormActivityCodeTest() throws Exception {
        ...
        // then
        String expectedCode = templatesProvider.provideTemplateForName("results/adapters/BFormAdapter.java");
        Assertions.assertThat(generatedCode).isNotNull().isEqualTo(expectedCode);
    }
}